...
namespace HanamikojiClient.States
{
    internal class AwaitingUserMakeMoveState : AbstractClientState
    {
        ...
        {
            _client.SendToServer(PacketCommandEnum.PlayerMove, _client.GetMoveData().SerializeToJson());
        }

        // tworzenie moveData
        //private void HandleCompromiseOffer()
        //{
        //    _client.NextMoveData.MoveType = PlayerMoveTypeEnum.CompromiseResponse;
        ...
        //    _client.NextMoveData.GiftCards = new List<GiftCard>() { selectedCard };
        //}

        //private void HandleDoubleGiftOffer()
        //{
        //    _client.NextMoveData.MoveType = PlayerMoveTypeEnum.DoubleGiftResponse;
        ...
        //    _client.NextMoveData.GiftCards = new List<GiftCard>() { selectedPair.card1, selectedPair.card2 };
        //}
        ...
        //    _client.NextMoveData.MoveType = selectedMoveType;
        ...
        //    _client.NextMoveData.GiftCards = new List<GiftCard>(selectedCards);
        //}
