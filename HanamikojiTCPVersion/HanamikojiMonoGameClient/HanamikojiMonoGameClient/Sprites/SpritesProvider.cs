...
namespace HanamikojiMonoGameClient.Sprites
{
    public static class SpritesProvider
    {
        ...
        public static Sprite GetGiftCardSprite(GeishaType geishaType) => geishaType switch
        {
            ...
            GeishaType.Geisha3_B => new(_cardsTextures, 433, 10, CardWidth, CardHeight),
            GeishaType.Geisha4_A => new(_cardsTextures, 349, 10, CardWidth, CardHeight),
        ...
        {
            GeishaType.Geisha2_A => new(_cardsTextures, 5, 253, GeishaSize, GeishaSize),
            ...
            GeishaType.Geisha3_A => new(_cardsTextures, 542, 253, GeishaSize, GeishaSize),
